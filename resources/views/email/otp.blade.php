...
<body style="font-family: Arial, sans-serif; text-align: center; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 400px; margin: auto; background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
        <div style="width:100%;display:block"> 
            <img src="https://grepublichub.store/img/logo.png" alt="Gaming Republic Hub" style="width: 100%; max-width: 200px; display: block; margin: 0 auto;">
        </div><h2>Welcome to Gaming Republic Hub!</h2>
